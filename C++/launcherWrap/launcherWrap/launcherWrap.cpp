...
constexpr auto* g_jvm_parameters =
	"-Xms8M -Xmx128M -XX:+UseParallelGC -XX:MaxHeapFreeRatio=20 -XX:MinHeapFreeRatio=10 -XX:NewRatio=3 -Xshareclasses -Xaggressive -Xquickstart -XX:+CompactStrings -XX:MaxTenuringThreshold=16";
