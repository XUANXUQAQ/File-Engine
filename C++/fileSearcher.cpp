...
int main(int argc, char *argv[])
{
    ...
    if (argc == 6)
    {
        ...
        strcat(output0_100, "\\list0-100.dat");
        strcpy(output100_200, output);
        strcat(output100_200, "\\list100-200.dat");
        strcpy(output200_300, output);
        strcat(output200_300, "\\list200-300.dat");
        strcpy(output300_400, output);
        strcat(output300_400, "\\list300-400.dat");
        strcpy(output400_500, output);
        strcat(output400_500, "\\list400-500.dat");
        strcpy(output500_600, output);
        strcat(output500_600, "\\list500-600.dat");
        strcpy(output600_700, output);
        strcat(output600_700, "\\list600-700.dat");
        strcpy(output700_800, output);
        strcat(output700_800, "\\list700-800.dat");
        strcpy(output800_900, output);
        strcat(output800_900, "\\list800-900.dat");
        strcpy(output900_1000, output);
        strcat(output900_1000, "\\list900-1000.dat");
        strcpy(output1000_1100, output);
        strcat(output1000_1100, "\\list1000-1100.dat");
        strcpy(output1100_1200, output);
        strcat(output1100_1200, "\\list1100-1200.dat");
        strcpy(output1200_1300, output);
        strcat(output1200_1300, "\\list1200-1300.dat");
        strcpy(output1300_1400, output);
        strcat(output1300_1400, "\\list1300-1400.dat");
        strcpy(output1400_1500, output);
        strcat(output1400_1500, "\\list1400-1500.dat");
        strcpy(output1500_1600, output);
        strcat(output1500_1600, "\\list1500-1600.dat");
        strcpy(output1600_1700, output);
        strcat(output1600_1700, "\\list1600-1700.dat");
        strcpy(output1700_1800, output);
        strcat(output1700_1800, "\\list1700-1800.dat");
        strcpy(output1800_1900, output);
        strcat(output1800_1900, "\\list1800-1900.dat");
        strcpy(output1900_2000, output);
        strcat(output1900_2000, "\\list1900-2000.dat");
        strcpy(output2000_2100, output);
        strcat(output2000_2100, "\\list2000-2100.dat");
        strcpy(output2100_2200, output);
        strcat(output2100_2200, "\\list2100-2200.dat");
        strcpy(output2200_2300, output);
        strcat(output2200_2300, "\\list2200-2300.dat");
        strcpy(output2300_2400, output);
        strcat(output2300_2400, "\\list2300-2400.dat");
        strcpy(output2400_2500, output);
        strcat(output2400_2500, "\\list2400-2500.dat");
        strcpy(output2500_, output);
        strcat(output2500_, "\\list2500-.dat");
...
int main()
{
    ...
    setSearchDepth(6);
    results0.open("D:\\Code\\C++\\output\\list0-100.dat", ios::app);
